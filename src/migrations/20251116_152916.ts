...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TABLE IF NOT EXISTS "respondents_sessions" (
  ...
  ALTER TABLE "surveys_rels" DROP CONSTRAINT IF EXISTS "surveys_rels_members_fk";
  
  ALTER TABLE "survey_responses" DROP CONSTRAINT IF EXISTS "survey_responses_member_id_members_id_fk";
  ...
  DROP INDEX IF EXISTS "surveys_rels_members_id_idx";
  DROP INDEX IF EXISTS "survey_responses_member_idx";
  ...
  ALTER TABLE "surveys_rels" ADD COLUMN IF NOT EXISTS "respondents_id" integer;
  ALTER TABLE "survey_responses" ADD COLUMN IF NOT EXISTS "respondent_id" integer;
  ALTER TABLE "payload_locked_documents_rels" ADD COLUMN IF NOT EXISTS "respondents_id" integer;
  ALTER TABLE "payload_preferences_rels" ADD COLUMN IF NOT EXISTS "respondents_id" integer;
  
  -- Set respondent_id to NOT NULL after adding it
  ALTER TABLE "survey_responses" ALTER COLUMN "respondent_id" SET NOT NULL;
  ...
  ALTER TABLE "surveys_rels" DROP COLUMN IF EXISTS "members_id";
  ALTER TABLE "survey_responses" DROP COLUMN IF EXISTS "member_id";
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "surveys_rels" DROP CONSTRAINT IF EXISTS "surveys_rels_respondents_fk";
  
  ALTER TABLE "survey_responses" DROP CONSTRAINT IF EXISTS "survey_responses_respondent_id_respondents_id_fk";
  
  ALTER TABLE "payload_locked_documents_rels" DROP CONSTRAINT IF EXISTS "payload_locked_documents_rels_respondents_fk";
  
  ALTER TABLE "payload_preferences_rels" DROP CONSTRAINT IF EXISTS "payload_preferences_rels_respondents_fk";
  
  DROP INDEX IF EXISTS "surveys_rels_respondents_id_idx";
  DROP INDEX IF EXISTS "survey_responses_respondent_idx";
  DROP INDEX IF EXISTS "payload_locked_documents_rels_respondents_id_idx";
  DROP INDEX IF EXISTS "payload_preferences_rels_respondents_id_idx";
  ALTER TABLE "surveys_rels" ADD COLUMN IF NOT EXISTS "members_id" integer;
  ALTER TABLE "survey_responses" ADD COLUMN IF NOT EXISTS "member_id" integer;
  ...
  -- Set member_id to NOT NULL after adding it
  ALTER TABLE "survey_responses" ALTER COLUMN "member_id" SET NOT NULL;
  ...
  ALTER TABLE "surveys_rels" DROP COLUMN IF EXISTS "respondents_id";
  ALTER TABLE "survey_responses" DROP COLUMN IF EXISTS "respondent_id";
  ALTER TABLE "payload_locked_documents_rels" DROP COLUMN IF EXISTS "respondents_id";
  ALTER TABLE "payload_preferences_rels" DROP COLUMN IF EXISTS "respondents_id";`);
}
